      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-[var(--border)]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-[var(--primary)]">Plateraa</span>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 border-t border-[var(--border)] space-y-3">
          ...
          <button
            onClick={toggleTheme}
            className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg bg-[var(--muted)] hover:bg-[var(--border)] transition-colors"
          >
          ...
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-[var(--foreground)] truncate">Admin User</p>
              <p className="text-xs text-[var(--muted-foreground)] truncate">admin@plateraa.com</p>
            </div>
          </div>
        </div>
      </aside>
