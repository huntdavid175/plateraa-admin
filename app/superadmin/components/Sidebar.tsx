      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-[var(--border)]">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="text-xl font-bold text-[var(--primary)]">Super Admin</span>
              <p className="text-xs text-[var(--muted-foreground)]">Platform Control</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 border-t border-[var(--border)] space-y-3">
          ...
          <button
            onClick={toggleTheme}
            className="w-full flex items-center justify-between px-3 py-2 rounded-lg bg-[var(--muted)] hover:bg-[var(--border)] transition-colors text-sm text-[var(--foreground)]"
          >
            <span>Theme</span>
            {theme === "dark" ? (
          ...
          <div className="px-3 py-2 rounded-lg bg-[var(--muted)]">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-[var(--foreground)] truncate">Super Admin</p>
                <p className="text-xs text-[var(--muted-foreground)] truncate">admin@platform.com</p>
              </div>
            </div>
          </div>
        </div>
